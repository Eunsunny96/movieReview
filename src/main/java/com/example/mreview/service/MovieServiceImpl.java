...
import com.example.mreview.Repositry.MovieImageRepository;
import com.example.mreview.Repositry.MovieRepository;
...
public class MovieServiceImpl implements MovieService {
    ...
    @Transactional
    @Override
    public Long register(MovieDTO movieDTO) { //dtoToEntity()에서 반환된 객체들을 이용해 save()
